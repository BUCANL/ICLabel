function answer = workaround_bsxfun(op, arg1, arg2)
...
% Tyler's note:
% Found this work after googling bsxfun being very slow on various
% versions of Matlab or Octave. Replacing ICLabel calls with this appears
% to have fixed the severe slowdowns.
